import {
  _sfc_main11 as _sfc_main,
  _sfc_main12 as _sfc_main2,
  _sfc_main15 as _sfc_main3,
  _sfc_main150 as _sfc_main8,
  _sfc_main18 as _sfc_main4,
  _sfc_main20 as _sfc_main5,
  _sfc_main24 as _sfc_main6,
  _sfc_main26 as _sfc_main7,
  createContext,
  useForwardPropsEmits
} from "./chunk-TABN76XI.js";
import {
  computed,
  createBaseVNode,
  createBlock,
...
var St = defineComponent({
  ...
  setup(e, { expose: n, emit: s }) {
    ...
    return n({
      open: l
    }), (m, u) => (openBlock(), createBlock(unref(_sfc_main), {
      open: unref(l),
      modal: unref(r),
      "onUpdate:open": h
    }, {
...
var Bt = defineComponent({
  ...
  setup(e) {
    ...
    return (w, d) => (openBlock(), createBlock(unref(_sfc_main5), {
      ref_key: "overlayRef",
      ref: n,
      "data-vaul-overlay": "",
...
var Ct = defineComponent({
  ...
  setup(e) {
    ...
    }), (f, y) => (openBlock(), createBlock(unref(_sfc_main3), {
      ref_key: "drawerRef",
      ref: w,
      "data-vaul-drawer": "",
...
export {
  _sfc_main2 as DrawerClose,
  Ct as DrawerContent,
  _sfc_main4 as DrawerDescription,
  Nt as DrawerHandle,
  Bt as DrawerOverlay,
  _sfc_main8 as DrawerPortal,
  St as DrawerRoot,
  _t as DrawerRootNested,
  _sfc_main6 as DrawerTitle,
  _sfc_main7 as DrawerTrigger
};
